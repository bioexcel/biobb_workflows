...
Once the workflow is finished, you just should enter the new **wf_notebook/biobb_wf_md_setup_mutations** folder and, inside it, you will find all the outputs generated by the workflow.
