...
def step35_gmx_trjconv_str(config, system=None):
    ...
    assert fx.compare_size(global_paths["step35_gmx_trjconv_str"]["output_str_path"], f'reference/step35_gmx_trjconv_str/{Path(global_paths["step35_gmx_trjconv_str"]["output_str_path"]).name}', 10)
