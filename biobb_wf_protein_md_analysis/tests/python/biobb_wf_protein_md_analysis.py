...
def step7_gmx_cluster(config, remove=False, system=None):
    ...
    assert fx.compare_size(global_paths["step7_gmx_cluster"]["output_cluster_log_path"], f'reference/step7_gmx_cluster/{Path(global_paths["step7_gmx_cluster"]["output_cluster_log_path"]).name}', 10)
