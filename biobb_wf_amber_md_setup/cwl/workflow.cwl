...
cwlVersion: v1.0
class: Workflow
label: AMBER Protein MD Setup
doc: |-
  This workflow performs a simulation setup of a protein system, compatible with the AMBER MD package.
inputs:
  step00_reduce_remove_hydrogens_input_path: File
  step00_reduce_remove_hydrogens_output_path: string
  step0_extract_molecule_output_molecule_path: string
  step000_cat_pdb_input_structure2: File
  step000_cat_pdb_output_structure_path: string
...
outputs:
  step00_reduce_remove_hydrogens_out1:
    label: output_path
    doc: |-
      Path to the output file
    type: File
    outputSource: step00_reduce_remove_hydrogens/output_path
  step0_extract_molecule_out1:
    label: output_molecule_path
    doc: |-
      Output molecule file path
    type: File
    outputSource: step0_extract_molecule/output_molecule_path
  step000_cat_pdb_out1:
    label: output_structure_path
    doc: |-
      Output protein file path
    type: File
    outputSource: step000_cat_pdb/output_structure_path
...
steps:
  step00_reduce_remove_hydrogens:
    ...
    in:
      input_path: step00_reduce_remove_hydrogens_input_path
      output_path: step00_reduce_remove_hydrogens_output_path
    out:
    - output_path
  step0_extract_molecule:
    ...
    in:
      input_structure_path: step00_reduce_remove_hydrogens/output_path
      output_molecule_path: step0_extract_molecule_output_molecule_path
    out:
  ...
  step000_cat_pdb:
    ...
    in:
      input_structure1: step0_extract_molecule/output_molecule_path
      input_structure2: step000_cat_pdb_input_structure2
      output_structure_path: step000_cat_pdb_output_structure_path
    out:
  ...
  step1_pdb4amber_run:
    ...
    in:
      input_pdb_path: step000_cat_pdb/output_structure_path
