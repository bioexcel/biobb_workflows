...
inputs:
  step00_reduce_remove_hydrogens_input_path:
    ...
    type: File
  step00_reduce_remove_hydrogens_output_path:
    label: Output file
    doc: Path to the output file.
    type: string
  step0_extract_molecule_output_molecule_path:
    label: Output file
  ...
  step000_cat_pdb_input_structure2:
    ...
    type: File
  step000_cat_pdb_output_structure_path:
    label: Output file
...
steps:
  ...
  step7_amber_to_pdb:
    ...
    in:
      input_top_path: step2_leap_gen_top/output_top_path
      input_crd_path: step5_sander_mdrun_min/output_rst_path
